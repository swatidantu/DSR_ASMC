...
void SpecificWorker::initialize(int period)
{
    ...
    else
    {
        ...
        // Custom widget
        dsr_viewer->add_custom_widget_to_dock("Path follower ASMC", &custom_widget);
...
void SpecificWorker::path_follower_ASMC_initialize()
{
                                                       ...
                                                       const Eigen::Vector2f &robot_nose, const Eigen::Vector2f &target)
{
    ...
    float theta_p = angle; //For sliding mode
